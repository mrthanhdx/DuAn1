...
public class home extends javax.swing.JFrame {
     ...
     */
    public home(String TenNhanVien, int idNV, String tencv) {
        initComponents();
        TenCV = tencv;
        id = idNV;
    ...
    private void setdashboad() {
        ...
        JFrame frame = new ban_Hang();
        JPanel framePanel = new JPanel(new BorderLayout());
        framePanel.add(frame.getContentPane(), BorderLayout.CENTER);
        setpanal(framePanel);
    }

    private void setColor(JPanel pane) {
        pane.setBackground(new Color(153, 102, 255));
    }

    private void resetColor(JPanel[] pane, JPanel[] indicators) {
        for (int i = 0; i < pane.length; i++) {
            pane[i].setBackground(new Color(153, 153, 255));
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 0, -1, 30));
        ...
        btnnhanvien.add(crep5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        btnnhanvien.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 0, 135, 60));
